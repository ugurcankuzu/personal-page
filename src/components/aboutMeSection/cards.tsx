...
export default function Card({ title, description, icon, note }: ICard) {
  return (
    <div className="min-w-[150px] max-w-[250px] h-[200px] bg-accent p-4 flex flex-col gap-4 rounded-md shadow-md shadow-accent snap-center">
      ...
      <p className="text-background font-normal text-[.5rem]">{description}</p>
